    ...
    <section className="p-5">
      ...
      <div className="content">
        ...
        <p className="mb-5 ">
          ...
          that will enhance the lives of our customers and community. As we move
          to greater heights, giving you the best customer experience is still
          our number one goal.
        </p>
        ...
        <p className="mb-5 ">
          ...
          - Penchant for fun <br />
          - Sincere customer focus <br />- Welcoming attitude towards change
        </p>
      </div>
    </section>
  );
